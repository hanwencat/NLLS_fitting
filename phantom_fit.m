...
p0 = [0.2, 0.5, 0.3, 0.01, 0.05, 0.25]; % intialization value (unit: seconds)
p_lower = [0, 0, 0, 0.005, 0.025, 0.15]; % lower bound
p_upper = [1, 1, 1, 0.025, 0.15, 0.3]; % upper bound
...
parfor x = 1:x_dim
    for y = 1:y_dim
        ...
        fitted_param(x,y,:) = [p_est, resnorm];   
    end
