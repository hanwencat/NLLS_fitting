...
% %% NLLS fitting with magnitude data
...
%% NLLS fitting with complex data
% fitting parameter for the 3-pool magnitude model
...
figure, subplot(131);imagesc(snr_range, mwf_range, phantom.phi0, [-pi,pi]); xlabel('SNR'); ylabel('MWF');
colormap(jet); colorbar; set(colorbar, 'YDir', 'reverse'); title('Truth phi0'); axis square;
subplot(132);imagesc(snr_range, mwf_range, fitted_param(:,:,10), [-pi,pi]); xlabel('SNR'); ylabel('MWF');
colormap(jet); colorbar; set(colorbar, 'YDir', 'reverse'); title('Fitted phi0');axis square;
subplot(133);imagesc(snr_range, mwf_range, (fitted_param(:,:,10) - phantom.phi0), [-pi,pi]); xlabel('SNR'); ylabel('MWF');
colormap(jet); colorbar; set(colorbar, 'YDir', 'reverse'); title('fitting error');axis square;
    
figure, subplot(131);imagesc(snr_range, mwf_range, phantom.fs_my, [-30,30]); xlabel('SNR'); ylabel('MWF');
colormap(jet); colorbar; set(colorbar, 'YDir', 'reverse'); title('Truth myelin water fs'); axis square;
subplot(132);imagesc(snr_range, mwf_range, fitted_param(:,:,7), [-30,30]); xlabel('SNR'); ylabel('MWF');
colormap(jet); colorbar; set(colorbar, 'YDir', 'reverse'); title('Fitted myelin water fs');axis square;
subplot(133);imagesc(snr_range, mwf_range, (fitted_param(:,:,7) - phantom.fs_my), [-30,30]); xlabel('SNR'); ylabel('MWF');
colormap(jet); colorbar; set(colorbar, 'YDir', 'reverse'); title('fitting error');axis square;

figure, subplot(131);imagesc(snr_range, mwf_range, phantom.fs_ax, [-20,20]); xlabel('SNR'); ylabel('MWF');
colormap(jet); colorbar; set(colorbar, 'YDir', 'reverse'); title('Truth axonal water fs'); axis square;
subplot(132);imagesc(snr_range, mwf_range, fitted_param(:,:,8), [-20,20]); xlabel('SNR'); ylabel('MWF');
colormap(jet); colorbar; set(colorbar, 'YDir', 'reverse'); title('Fitted axonal water fs');axis square;
subplot(133);imagesc(snr_range, mwf_range, (fitted_param(:,:,8) - phantom.fs_ax), [-20,20]); xlabel('SNR'); ylabel('MWF');
colormap(jet); colorbar; set(colorbar, 'YDir', 'reverse'); title('fitting error');axis square;
